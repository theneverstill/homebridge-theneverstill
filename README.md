...
1. `TNS Clock` Accessory
   ...
   1. [See 'Inspiration Accessories' section below](#inspiration-accessories "Accessories to Inspire Your HomeKit Home") for inspiration on how to fully leverage the `TNS Clock` accessory

#### Inspiration Accessories

1. Unresponsive Device Alarm

1. Ideal State Switch

1. Motion Sensor Cooldown Trigger
